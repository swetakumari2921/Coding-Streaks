...
class Showtime implements Comparable<Showtime> {
	...
	public int compareTo(Showtime s) {
		return Double.compare(s.dynamicPrice, this.dynamicPrice); // descending
	}
}

public class Ex23MovieBookingSystemLinkedList {
	...
	public static void main(String[] args) {
		...
		for (Showtime s : showtimes) {
			System.out.println(s.name + " | Tickets: " + s.tickets + " | Price: ₹" + Math.round(s.dynamicPrice));
		}
