...
class Product3 {
	...
	Product3(String name, int stock) {
		this.name = name;
		this.stock = stock;
	}
}
...
public class Ex28 {
	public static void main(String[] args) {
		...
		LinkedList<Product3> catalog = new LinkedList<>();
		...
		for (int i = 0; i < n; i++) {
			...
			catalog.add(new Product3(name, stock));
		...
		for (int i = 0; i < m; i++) {
			...
			case "add":
				...
				catalog.add(new Product3(addName, addStock));
