...
<title>FinNexa | Deposit Money</title>
...
input[type="submit"] {
	...
	padding: 12px;
	font-size: 16px;
	font-weight: 800; /* Deposit button thickness */
	border-radius: 5px;
	cursor: pointer;
	margin-top: 18px;
...
/* Text - Medium Bold (Deposit se kam, normal se zyada) */
.back-link a span.text {
	font-weight: 600;
	border-bottom: 2px solid transparent; /* Hidden line */
	padding-bottom: 1px;
